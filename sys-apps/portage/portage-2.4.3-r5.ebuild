...
#FL-3333 and #FL-3687 are covered in add-sync-branch-and-sync-enforcing.patch
#FL-3755 and FL-3986 are covered by funtoo-make-globals.patch
# Gentoo #624618 workaround for proper portage mirroring support covered
#
PATCHES=(
	"${FILESDIR}/${P}-sync-branch-sync-enforcing.patch"
	"${FILESDIR}/${P}-funtoo-make-globals.patch"
	"${FILESDIR}/${P}-remove-gentoo-repos-conf.patch"
	"${FILESDIR}/${P}-gentoo-624618.patch"
)
python_prepare_all() {
